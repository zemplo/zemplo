	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Grey", "Blue", "Dark", "Lights", "Orange", "Radiate")),
			...
			array( "name" => "Comment date format",
				   "id" => $shortname."_comment_date_format",
				   "std" => "d-m-Y",
                   "type" => "text",
				   "desc" => "This option allows you to change how your dates are displayed. For more information please refer to the WordPress codex here:<a href='http://codex.wordpress.org/Formatting_Date_and_Time' target='_blank'>Formatting Date and Time</a>"),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show these pages on Homepage",
				   ...
				   "type" => "checkboxes",
				   "std" => '',
				   "desc" => "Here you can choose the pages you would like to show on the homepage. This does not apply when blog style mode is enabled. ",
				   "usefor" => "pages",
				   "excludeDefault" => "true",
				   "options" => $pages_ids),
				   
			array( "name" => "Number of Posts displayed on homepage  (in Blog style)",
                   "id" => $shortname."_homepage_posts",
                   "std" => "6",
                   "type" => "text",
				   "desc" => "Here you can designate how many recent articles are displayed on homepage. This option works independently from the Settings > Reading options in wp-admin."),
				   
			array( "name" => "Exclude categories from homepage recent posts  (in Blog style)",
